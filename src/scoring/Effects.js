    class Effects {
        ...
        static STYLE = {
            ...
            rock: [{ source: 'style', sourceType: 'rock', destination: 'add', operation: 'add', value: 10  }],
        };

        // Each modifier can produce multiple effects; a piece may have several modifiers stacked
        static MODIFIER = {
            holo:    [{ source: 'modifier', sourceType: 'holo',    destination: 'mult', operation: 'add',  value: 10   }],
            poly:    [{ source: 'modifier', sourceType: 'poly',    destination: 'mult', operation: 'mult', value: 1.5  }],
            shine:   [{ source: 'modifier', sourceType: 'shine',   destination: 'add',  operation: 'add',  value: 50   }],

            neon:    [{ source: 'modifier', sourceType: 'neon',    destination: 'mult', operation: 'add',  value: 5   }],

            metal:   [{ source: 'modifier', sourceType: 'metal',   destination: 'mult', operation: 'mult', value: 1.5 }],
            glass:   [{ source: 'modifier', sourceType: 'glass',   destination: 'mult', operation: 'mult', value: 2   }], // break chance
            gold:    [{ source: 'modifier', sourceType: 'gold',    destination: 'add',  operation: 'add',  value: 5   }], // destination money
            stripes: [{ source: 'modifier', sourceType: 'stripes', destination: 'mult', operation: 'add',  value: 4   }],
        };
